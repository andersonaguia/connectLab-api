...
exports.addUserDevicesEntity1673281571337 = void 0;
var addUserDevicesEntity1673281571337 = /** @class */ (function () {
    function addUserDevicesEntity1673281571337() {
        this.name = 'addUserDevicesEntity1673281571337';
    }
    addUserDevicesEntity1673281571337.prototype.up = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, queryRunner.query("CREATE TABLE \"user_devices_location\" (\"id\" SERIAL NOT NULL, \"deviceLocation\" character varying(30) NOT NULL, CONSTRAINT \"PK_34fe9059c52c90b17a63c410e9e\" PRIMARY KEY (\"id\"))")];
                    case 1:
                        _a.sent();
    ...
    addUserDevicesEntity1673281571337.prototype.down = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    return addUserDevicesEntity1673281571337;
}());
exports.addUserDevicesEntity1673281571337 = addUserDevicesEntity1673281571337;
