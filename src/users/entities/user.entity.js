...
var user_role_1 = require("../enum/user.role");
var user_devices_entity_1 = require("./user-devices.entity");
var UserEntity = /** @class */ (function () {
    function UserEntity() {
    }
    UserEntity.prototype.checkPassword = function (password) {
    ...
    __decorate([
        (0, typeorm_1.OneToOne)(function (type) { return address_entity_1.AddressEntity; }, function (address) { return address.id; }, { cascade: true, eager: true }),
    ...
    __decorate([
        (0, typeorm_1.Column)({ type: "enum",
            ...
            "default": user_role_1.UserRole.CLIENT })
    ...
    ], UserEntity.prototype, "userDevices");
